...
## [1.0.0-alpha.2](https://github.com/cassc/revm/compare/revm-database-v1.0.0-alpha.1...revm-database-v1.0.0-alpha.2) - 2025-03-06

### Fixed

- use correct HashMap import ([#2148](https://github.com/cassc/revm/pull/2148))
- *(op)* Handler deposit tx halt, catch_error handle ([#2144](https://github.com/cassc/revm/pull/2144))

### Other

- *(db)* separate fields from `CacheDB` into `Cache` ([#2131](https://github.com/cassc/revm/pull/2131))
