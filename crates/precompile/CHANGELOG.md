...
## [17.0.0-alpha.2](https://github.com/cassc/revm/compare/revm-precompile-v17.0.0-alpha.1...revm-precompile-v17.0.0-alpha.2) - 2025-03-06

### Fixed

- *(blst)* Fix blst wrong constants values and usage ([#2102](https://github.com/cassc/revm/pull/2102))

### Other

- simplify bn128::run_pair ([#2137](https://github.com/cassc/revm/pull/2137))
- export eip2930 eip7702 types from one place ([#2097](https://github.com/cassc/revm/pull/2097))
- PrecompileErrors to PrecompileError ([#2103](https://github.com/cassc/revm/pull/2103))
- Update broken link secp256r1.rs ([#2099](https://github.com/cassc/revm/pull/2099))
- G1_msm base gas fee const correction ([#2100](https://github.com/cassc/revm/pull/2100))
- Split blst constants out to individual file #2085
- *(deps)* bump breaking deps ([#2093](https://github.com/cassc/revm/pull/2093))
