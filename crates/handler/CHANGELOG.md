...
## [1.0.0-alpha.2](https://github.com/cassc/revm/compare/revm-handler-v1.0.0-alpha.1...revm-handler-v1.0.0-alpha.2) - 2025-03-06

### Fixed

- *(op)* Handler deposit tx halt, catch_error handle ([#2144](https://github.com/cassc/revm/pull/2144))
- call clear ([#2091](https://github.com/cassc/revm/pull/2091))
